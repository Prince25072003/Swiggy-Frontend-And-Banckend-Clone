...
import {restaurantsDetails} from "../utils/restaurantdetail";
...
export default function RestaurantMenu(){
 ...
 const [RestDataA, setRestDataA] = useState([]);
    ...
    return(
      <div>
         ...
         <div className="w-[80%] mt-20 mx-auto mb-20">
            ...
            <button className={`text-2xl py-2 px-4 border rounded-2xl ${selected==="nonveg"?"bg-red-500":"bg-gray-300"}`} onClick={()=>setSelected(selected==='nonveg'?null:'nonveg')}>NonVeg</button>
         </div>
